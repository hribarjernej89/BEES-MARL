...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.fp1 = nn.Linear(state_size, 32)
        self.fp2 = nn.Linear(32, 64)
        self.head_values = nn.Linear(64, 1)
        self.head_advantages = nn.Linear(64, action_size)
...
class DQNAgent(object):
    def __init__(self, num_states, num_actions, batch_size=1024, epsilon=.99,
                 epsilon_decay=.9998, epsilon_min=.2, tau=.001, memory_size=10000, learning_rate=.01,
